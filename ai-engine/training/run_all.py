...
def run_full_pipeline(dataset_path: str = "../data/compressed_DataSet.xlsx"):
    ...
    logger.info("\n[2/10] Running 5-stage feature selection pipeline ...")
    ...
    # ── Step 8: Train GNN ─────────────────────────────────────
    logger.info("\n[8/10] Building graph and training GNN ...")
    ...
    logger.info("\n[9/10] Training meta-learner (stacker) ...")
    ...
    # ── Step 9b: Train VAE ────────────────────────────────────
    logger.info("\n[9b/10] Training VAE on legitimate accounts ...")
